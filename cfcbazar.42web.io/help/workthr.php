...
<head>
  ...
  <link rel="canonical" href="https://cfcbazar.42web.io/help/workthr.php" />
...
<section>
  ...
  <ul>
    <li><a href="/d.php" target="_blank">Dashboard</a></li>
    <li><a href="/d.php" target="_blank">Dashboard</a></li>
  </ul>
  <p>Displayed tokens:</p>
  <ul>
    <li><strong>dWorkTokens</strong>: your WTK balance</li>
    <li><strong>mWorkTokens</strong>: your mined WorkTHR balance</li>
  </ul>
</section>
...
<section>
  ...
  <ul>
    ...
    <li>Deposit: <a href="/buy.php" target="_blank">on this page</a>.</li>
    <li>Withdraw: <a href="/w.php" target="_blank">on this page</a>.</li>
  </ul>

  <h3>WorkTHR</h3>
  <ul>
    <li>Buy/sell on <a href="https://pancakeswap.finance/" target="_blank">PancakeSwap</a> using token address <code>0xffc4f8Bde970D87f324AefB584961DDB0fbb4F00</code></li>
    <li>Deposit/withdraw support requires a registration.</li>
  </ul>
</section>

<section>
  <h2>🔄 Migration Strategy</h2>
  <p>CfCbazar is actively transitioning all systems to <strong>WTK & WorkTHR</strong>. WorkTHR remains supported, but all new features, guides, and storefronts will prioritize WTK.</p>
</section>
...
<section>
  ...
  <ul>
    ...
    <li><a href="/d.php" target="_blank">Dashboard</a></li>
    <li><a href="/buy.php" target="_blank">Buy WorkToken</a></li>
    <li><a href="/w.php" target="_blank">Withdraw WorkToken</a></li>
