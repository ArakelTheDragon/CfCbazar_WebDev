...
<main class="content-container">
  <section class="header">
    ...
    <p>Discover smart deals, DIY tolls and projects, music, games and how to earn and use WorkTokens and WorkTHR through mining, deposits, and how you can use platform features & games or withrdaw your mined WorkTokens to your Metamask wallet</p>
  </section>
...
CfCbazar Ecosystem  
<ul>
  <li>CfCbazar offers smart deals, items, and discounts with great value for money.</li>
  <li>The DIY section provides tools we have created ourselves and shows you how to make various devices and self‑made projects.</li>
  <li>The music section gives you access to our own music.</li>
  <li>The games section allows you to play our self‑made games with or without WorkTokens.</li>
  <li>
    The WorkToken is our utility token that you can use on the platform, mine, or withdraw. 
    WorkTHR is the reserve “Fort Knox” of the platform—preminted, stable, and tradable on PancakeSwap, Uniswap, and SushiSwap. 
    It anchors the ecosystem and backs future growth.
  </li>
  <li>
    WTK (WorkTokenStable) is the main utility token, minted and burned directly through its smart contract with BNB. 
    While a small pool exists on PancakeSwap, CfCbazar recommends buying and selling WTK via the 
    <a href="https://cc.free.bg/workth/">contract</a> for fairness and transparency.
  </li>
  <li>
    Since we have a very small amount of WTK for mining, if you withdraw WTK you will receive WorkTHR instead.
  </li>
  <li>
    WorkTH (MintMe) is discontinued, with all new guides and tools prioritizing WTK.
  </li>
</ul>
