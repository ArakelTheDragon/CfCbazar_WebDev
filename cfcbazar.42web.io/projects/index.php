...
<head>
    ...
    <meta property="og:image" content="https://yourwebsite.com/images/esp8266-logo.jpg">
...
<body>
    ...
    <div class="projects-container">
        ...
        <?php elseif (empty($projects)): ?>
            <div class="error-message">No projects available at the moment.</div>
        <?php else: ?>
            <?php
                ...
                <?php foreach ($filteredProjects as $project): ?>
                    <div class="project">
                        ...
                        <?php if (!empty($project['article'])): ?>
                            <?php
                            // Ensure local PHP articles in the same folder
                            $articleLink = $project['article'];
                            if (!preg_match('~^https?://~', $articleLink)) {
                                $articleLink = './' . ltrim($articleLink, '/');
                            }
                            ?>
                            <p><strong>Article:</strong>
                                <a href="<?= htmlspecialchars($articleLink) ?>" target="_blank">
