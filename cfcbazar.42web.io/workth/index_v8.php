...
// pull from config.php  
$mintme_wallet = $mintme_wallet;  
$api_id        = $private_key;     // using your private key for X-API-ID  
$api_key       = $api_key;         // your public key for X-API-KEY  
...
<head>  
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .copy-container { gap: 12px; width: 100%; }
    .copy-text {
      flex: 1;
...
<body>  
  ...
  <main>
    ...
    <div id="countdown" class="countdown" style="display:none">⏱️ Time left: <span id="timer"></span> seconds</div>
  ...
  <main>
    ...
    <ul>
      ...
      <li>🚀 <strong>Run this command:</strong><br>
        <code>webchain-miner -o web-ko1.gonspool.com:3333 -u YourMintmeWallet -p x <u><i><b>but sometimes you have to add / or ./ or \ or .\ right before webchain-mimer!</b></i></u></code>
      </li>
    ...
    function startTimer() {
      ...
      interval = setInterval(() => {
        ...
        if (seconds <= 0) {
          ...
          document.getElementById("result").textContent = "❌ Transaction not found within 5 minutes.";

          // Re-enable buttons and reload after brief pause for new amount
          depBtn.disabled = false;
          homeBtn.disabled = false;
          depBtn.innerText = "I Deposited the Amount";
        ...
        fetch("index.php?check=1")
          ...
          .then(msg => {
            if (msg.includes("✅")) {
              ...
              // Hide deposit button, enable home
