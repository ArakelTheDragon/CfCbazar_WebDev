...
<main>
  ...
  <div id="countdown" style="display:none">⏱️ Time left: <span id="timer">60</span> seconds</div>
  <div id="result" style="display:none"></div>
  <div id="console-log"><strong>Console:</strong><br /></div>
</main>
<script>
  let seconds = 60, interval, checker;
  ...
  function startTimer() {
    ...
    interval = setInterval(() => {
      ...
      if (seconds <= 0) {
        ...
        document.getElementById('result').textContent = '❌ Not found in 60 seconds.';
