...
function call_openrouter($messages)
{
    ...
    // ------------------------------------------------------------------------
    // Tools Configuration (Web Search, Fetch, Image Gen, Advisor, Subagent, Fusion, PDF)
    // ------------------------------------------------------------------------
    ...
    $tools = [
        ...
        // OpenRouter Server-Side Image Generation
        [
...
$systemMessage = [
    ...
    'content' =>
        ...
        'technical questions, writing, general questions, real-time web search, fetching URL page content, generating images, advisor guidance, delegating tasks to subagents, multi-perspective model fusion analysis, and PDF generation. ' .

        'When searching or retrieving webpage content via URL, summarize ' .
        'the extracted information cleanly for the user. ' .

        'When generating images, render the image using markdown image syntax: ![description](image_url). ' .
...
if (
    ...
    // =========================================================================
    // TOOL CALL (CLIENT-SIDE FUNCTION / PDF)
    // =========================================================================
    ...
    if (!empty($msg['tool_calls']) && is_array($msg['tool_calls'])) {
        ...
        foreach ($msg['tool_calls'] as $toolCall) {
            ...
            if (!is_array($args)) {
                $toolResult = [
                    'success' => false,
                    'error' => 'Invalid PDF tool arguments: ' . json_last_error_msg()
                ];
            }
        ...
        if (empty($secondResponse['success'])) {
            ...
            $errorText = $secondResponse['error'] ?? 'Unknown OpenRouter error after PDF generation.';
    ...
    // =========================================================================
    // NORMAL AI RESPONSE (OR SERVER-SIDE SEARCH / FETCH / IMAGE / ADVISOR / SUBAGENT / FUSION)
    // =========================================================================
...
<div class="ai-agent-wrapper">
    ...
    <div class="ai-agent-title">
        ...
        <p>Ask questions, get help, search the web, fetch URLs, generate images, or request a PDF.</p>
    </div>
